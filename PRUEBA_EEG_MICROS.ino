...
void processMC(OSCMessage &msg, int addrOffset) {  
  if(msg.match("/neutral", addrOffset)) {
    auxpush=0; auxpull=0;auxderecha=0;auxizquierda=0;
    auxneutral++;
    if(auxneutral<2){
      ...
      auxneutral=0; auxpull=0;auxizquierda=0;auxderecha=0;
      auxpush++;
      if(auxpush<2){
     ...
     auxneutral=0; auxpush=0;auxizquierda=0;auxderecha=0;
    auxpull++;
    if (auxpull<2){
    ...
    auxneutral=0; auxpush=0; auxpull=0; auxderecha=0;
    auxizquierda++;
    if(auxizquierda<2){
    ...
    auxneutral=0; auxpush=0; auxpull=0; auxizquierda=0;
    auxderecha++;
    if(auxderecha<2){
